...
%\begin{table}
%\begin{centering}
%\protect\caption{Dataset sizes and parameter optimisations.\label{tab:parameters}}
%
%\par\end{centering}
%
%\centering{}%
%\begin{tabular}{|>{\raggedright}p{0.07\textwidth}|>{\raggedright}p{0.08\textwidth}|>{\raggedright}p{0.13\textwidth}|>{\raggedright}p{0.13\textwidth}|}
%\hline 
%\textbf{\footnotesize{}Dataset} & \textbf{\footnotesize{}\# runs}\\
%\textbf{\footnotesize{}(\# features)} & \textbf{\footnotesize{}HDP-Align} & \textbf{\footnotesize{}SIMA, Join}\tabularnewline
%\hline 
%\textbf{\footnotesize{}Proteomic} &  & \multirow{7}{0.13\textwidth}{{\footnotesize{}$\sqrt{\rho^{-1}}=500$ ppm,}\\
%{\footnotesize{}$\sqrt{\gamma^{-1}}=2$ s,}\\
%{\footnotesize{}$\sqrt{\delta^{-1}}=50$ s}} & \multirow{7}{0.13\textwidth}{{\footnotesize{}$T_{(m/z)}=\{1.0,1.1,...,2.0\}$,}\\
%{\footnotesize{}$T{}_{rt}=\{10,20,...,180\}$ s}}\tabularnewline
%{\footnotesize{}Frac 000} & {\footnotesize{}2 (10606)} &  & \tabularnewline
%{\footnotesize{}Frac 020} & {\footnotesize{}2 (2135)} &  & \tabularnewline
%{\footnotesize{}Frac 040} & {\footnotesize{}2 (2188)} &  & \tabularnewline
%{\footnotesize{}Frac 060} & {\footnotesize{}2 (3342)} &  & \tabularnewline
%{\footnotesize{}Frac 080} & {\footnotesize{}2 (2086)} &  & \tabularnewline
%{\footnotesize{}Frac 100} & {\footnotesize{}2 (1326)} &  & \tabularnewline
%\hline 
%\textbf{\footnotesize{}Glycomic} & {\footnotesize{}10 (9344)} & {\footnotesize{}$\sqrt{\rho^{-1}}=3$ ppm,}\\
%{\footnotesize{}$\sqrt{\gamma^{-1}}=2$ s,}\\
%{\footnotesize{}$\sqrt{\delta^{-1}}=20$ s} & {\footnotesize{}$T_{(m/z)}=\{0.05,0.1,0.25\}$,}\\
%{\footnotesize{}$T{}_{rt}=\{5,10,...,120\}$ s}\tabularnewline
%\hline 
%\textbf{\footnotesize{}Metabolo-mic} & {\footnotesize{}6 (7477)} & {\footnotesize{}$\sqrt{\rho^{-1}}=3$ ppm,}\\
%{\footnotesize{}$\sqrt{\gamma^{-1}}=2$ s,}\\
%{\footnotesize{}$\sqrt{\delta^{-1}}=20$ s} & {\footnotesize{}$T_{(m/z)}=\{0.001,0.01,0.1\}$,}\\
%{\footnotesize{}$T{}_{rt}=\{5,10,...,120\}$ s}\tabularnewline
%\hline 
%\end{tabular}
%\end{table}
